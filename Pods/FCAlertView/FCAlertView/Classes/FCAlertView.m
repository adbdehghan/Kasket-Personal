...
- (void)drawRect:(CGRect)rect {
    ...
    if (_title != nil)
        descriptionLabel.font = [UIFont fontWithName:@"IRANSans" size:15];
    else
        descriptionLabel.font = [UIFont fontWithName:@"IRANSans" size:16];
    ...
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(15.0f,
                                                                    ...
                                                                    20.0f)];
    titleLabel.font = [UIFont fontWithName:@"IRANSans" size:15];
    ...
    if (_numberOfButtons == 0) { // View only contains DONE/DISMISS Button
        ...
        doneButton.titleLabel.font = [UIFont fontWithName:@"IRANSans" size:15];
        ...
        otherButton.titleLabel.font = [UIFont fontWithName:@"IRANSans" size:15];
        ...
        firstButton.titleLabel.font = [UIFont fontWithName:@"IRANSans" size:15];
        ...
        secondButton.titleLabel.font = [UIFont fontWithName:@"IRANSans" size:15];
